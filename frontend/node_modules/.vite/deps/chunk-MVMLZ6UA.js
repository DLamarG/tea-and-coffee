...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React35.useContext(DropdownContext);
  if (menuContext === null) {
...
function useMenuItem(params) {
  ...
  const itemMetadata = React37.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React37.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React39.memo(React39.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React39.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var InnerOption = React46.memo(React46.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React46.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime31.jsx)(React51.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MVMLZ6UA.js.map
